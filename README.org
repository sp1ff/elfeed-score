...
#+BEGIN_SRC bash
cd /tmp
curl -L --output elfeed-score-0.7.9.tar.gz https://github.com/sp1ff/elfeed-score/releases/download/0.7.9/elfeed-score-0.7.9.tar.gz
tar xvf elfeed-score-0.7.9.tar.gz && cd elfeed-score-0.7.9
...
curl -L --output=elfeed-score-0.7.9.tar.gz https://github.com/sp1ff/elfeed-score/releases/download/0.7.9/elfeed-score-0.7.9.tar.gz
tar xvf elfeed-score-0.7.9.tar.gz && cd elfeed-score-0.7.9
export EMACSLOADPATH=/tmp/elfeed-score-0.7.9:/tmp/elfeed:/tmp/elfeed/tests:$EMACSLOADPATH
./configure
make
make check
sudo make install
