...
#+BEGIN_EXAMPLE
cd /tmp
curl -L --output elfeed-score-0.6.0.tar.gz https://github.com/sp1ff/elfeed-score/releases/download/0.6.0/elfeed-score-0.6.0.tar.gz
tar xvf elfeed-score-0.6.0.tar.gz && cd elfeed-score-0.6.0
