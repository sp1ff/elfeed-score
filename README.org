...
At this point, I'm letting the latest =0.7= code "bake" in my production Emacs instance; if no major issues crop up in the next few days I'll merge into =master= & release.
* Introduction
